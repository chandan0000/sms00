...
def main():
    ...
    print(
        '\033[1;77m /____/ /_/  /_/  /____/ \033[1;31m /_____/ \____//_/ /_/ /_//_.___/\___//_/ \033[0m\033[1;77mv1.0      \033[0m')
    print('\n')
    print('\033[1;77mhttps://github.com/thelinuxchoice/smsbomber')
    print('\033[1;77mtwitter: @linux_choice')
    print(
        '\033[1;31m[!] Legal disclaimer: Educational purposes only. Use only against your own number. Developers are not responsible for any damage caused by this program\033[0m\n')
